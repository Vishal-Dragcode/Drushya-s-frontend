          ...
          <div className="p-8 md:p-12 lg:col-span-2 bg-gray-50 flex flex-col justify-center border-r border-gray-100">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-sm text-gray-900 uppercase tracking-wider font-semibold mb-2">Contact Numbers</h4>
                  <div className="space-y-1">
                    <p className="text-gray-600">+91 9158212338</p>
                    <p className="text-gray-600">+91 9270500511</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-8 md:p-12 lg:col-span-3 flex flex-col justify-center bg-white">
            ...
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-lg px-4 py-3 focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 transition-all duration-300 appearance-none">
              ...
              <Button type="button" variant="primary" fullWidth className="mt-2 text-lg">
                Send Message
              </Button>
            </form>
          </div>
