...
const packageData = {
  maternity: { category: 'portrait', title: 'Maternity Package', description: 'Celebrate the glow of motherhood with elegant, timeless portraiture and capture these fleeting moments.', thumbnail: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=2000&auto=format&fit=crop' },
  newborn: { category: 'portrait', title: 'Newborn Package', description: 'Gentle, safe, and beautiful sessions to capture their earliest days with artistic setups.', thumbnail: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=2000&auto=format&fit=crop' },
  kids: { category: 'portrait', title: 'Kids Package', description: 'Energetic and candid portraits of your child\'s unique personality in a fun environment.', thumbnail: 'https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?q=80&w=2000&auto=format&fit=crop' },
  family: { category: 'portrait', title: 'Family Package', description: 'Heartwarming sessions capturing the love and connection of your family together.', thumbnail: 'https://images.unsplash.com/photo-1511895426328-dc8714191300?q=80&w=2000&auto=format&fit=crop' },
  wedding: { category: 'wedding', title: 'Wedding Ceremony', description: 'Cinematic and comprehensive coverage of your special day, capturing every emotion.', thumbnail: 'https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=2000&auto=format&fit=crop' },
  prewedding: { category: 'wedding', title: 'Pre-wedding Shoots', description: 'Romantic and cinematic shoots at breathtaking locations to celebrate your engagement.', thumbnail: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=80&w=2000&auto=format&fit=crop' },
  engagement: { category: 'wedding', title: 'Engagements', description: 'Discrete and emotional coverage of your perfect proposal, ensuring natural reactions.', thumbnail: 'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?q=80&w=2000&auto=format&fit=crop' },
  reception: { category: 'wedding', title: 'Receptions & Parties', description: 'Capturing all the fun, laughter, and beautiful details of your grand celebration.', thumbnail: 'https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=80&w=2000&auto=format&fit=crop' },
  events: { category: 'corporate', title: 'Corporate Events', description: 'Professional coverage for your galas, conferences, and seminars with quick delivery.', thumbnail: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?q=80&w=2000&auto=format&fit=crop' },
  branding: { category: 'corporate', title: 'Brand Identity', description: 'Compelling visual narratives that communicate your values to your ideal clients.', thumbnail: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2000&auto=format&fit=crop' },
  promotions: { category: 'corporate', title: 'Promotions', description: 'High-impact visuals designed specifically for your marketing channels and social media.', thumbnail: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=2000&auto=format&fit=crop' },
  headshots: { category: 'corporate', title: 'Professional Headshots', description: 'High-end corporate headshots for your leadership team, taken at your office or our studio.', thumbnail: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=2000&auto=format&fit=crop' },
  advertisements: { category: 'commercial', title: 'Advertisements', description: 'High-impact imagery carefully crafted for billboards, print, and digital ad campaigns.', thumbnail: 'https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=2000&auto=format&fit=crop' },
  product: { category: 'commercial', title: 'Product Shoots', description: 'Sleek studio and lifestyle photography to beautifully highlight your unique offerings.', thumbnail: 'https://images.unsplash.com/photo-1444653389962-8149286c578a?q=80&w=2000&auto=format&fit=crop' },
  musicvideos: { category: 'commercial', title: 'Music Videos', description: 'Full-scale cinematography to create visually stunning and engaging music videos.', thumbnail: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?q=80&w=2000&auto=format&fit=crop' },
  fashion: { category: 'commercial', title: 'Fashion Editorials', description: 'Avant-garde shoots and lookbooks that define style and highlight your latest collection.', thumbnail: 'https://images.unsplash.com/photo-1551316679-9c6ae9dec224?q=80&w=2000&auto=format&fit=crop' },
  default: { category: 'portrait', title: 'Premium Photography Package', description: 'Master your visual presence with our updated package. Enjoy core concepts, advanced techniques, and stunning responsive delivery.', thumbnail: '/images/home_banner1.jpg' }
};
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl p-6 md:p-8 animate-fade-in-up">
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); onClose(); alert('Booking Request Submitted Successfully!'); }}>
          <div>
          ...
          <div className="pt-2">
            <Button 
              ...
              variant="primary" 
              fullWidth 
              className="py-3 text-base font-bold shadow-lg shadow-yellow-400/30"
            >
...
const ReviewSection = ({ packageName }) => {
  const [reviews, setReviews] = useState([
    { id: 1, name: 'Alice Smith', rating: 5, date: 'October 12, 2023', comment: 'Absolutely loved the experience! The photos are stunning.' },
    { id: 2, name: 'John Doe', rating: 4, date: 'November 05, 2023', comment: 'Great service and professional team. Highly recommend.' }
  ]);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2">
            <Button
              type="submit"
              variant="primary"
              className="py-2.5 px-6 text-sm font-bold shadow-md shadow-yellow-400/20"
            >
              Submit Review
            </Button>
          </div>
  ...
  return (
    <div className="w-full min-h-screen bg-white text-gray-900 font-sans pb-20">
      ...
      <div className="relative w-full h-[40vh] md:h-[50vh] bg-black mb-12">
        <img
          src={data.thumbnail || "/images/home_banner1.jpg"}
          alt={data.title}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:flex lg:gap-16 lg:items-start">
        ...
        <div className="lg:w-[65%]">
          ...
          {/* Review Section */}
          <ReviewSection packageName={data.title} />
